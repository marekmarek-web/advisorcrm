    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
          ...
          <div className="space-y-4">
            <InputAmount label="Hlavní příjem (čistého)" value={inc.main ?? 0} onChange={(v) => setCashflowField("incomes.main", v)} id="income-main" />
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Ostatní (nájem, dávky…)</label>
        ...
        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
          ...
          <div className="space-y-4">
            ...
            <InputAmount label="Pojistky" value={exp.insurance ?? 0} onChange={(v) => setCashflowField("expenses.insurance", v)} id="exp-insurance" />
            <div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center"><Shield className="w-4 h-4 text-amber-500" /></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-50 rounded-xl p-6 border border-slate-100 flex flex-col justify-center">
            ...
            <div className="flex justify-between items-center mt-2 pt-2 border-t border-slate-200">
              ...
              <span className="font-bold text-amber-600 text-lg">{formatCzk(reserveGapVal)}</span>
            </div>
            {isReserveMet && (
