  ...
  return (
    <>
      <button
        ...
        className={`fixed ${positionClass} flex min-h-[48px] min-w-[48px] items-center justify-center rounded-full border-2 border-[color:var(--wp-surface-card-border)] bg-[color:var(--wp-surface-muted)] text-[color:var(--wp-text)] shadow-md transition-all hover:bg-[color:var(--wp-surface-muted)] hover:border-slate-400 active:scale-95 dark:border-slate-400 dark:bg-slate-500 dark:text-white dark:hover:bg-slate-400 dark:hover:border-[color:var(--wp-surface-card-border)]`}
