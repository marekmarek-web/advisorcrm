...
export type HouseholdDetail = {
  ...
  name: string;
  icon: string | null;
  members: { id: string; contactId: string; firstName: string; lastName: string; email: string | null; role: string | null }[];
};
