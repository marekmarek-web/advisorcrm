...
- MULTI-PERSON / MULTI-INSURED: Více osob (pojistník ≠ pojištěný, děti, spoludlužník) extrahuj každou zvlášť do parties viz RULE 3 výše. U životního pojištění povinně vrať insuredPersons[] pro všechny bloky "1. pojištěný", "2. pojištěný", "3. pojištěný". Pokud dokument uvádí "Počet pojištěných", délka insuredPersons[] musí odpovídat.
- MULTI-INSURED PREMIUM: Řádek "Celkové běžné měsíční pojistné pro N. pojištěného" patří ke konkrétní osobě N. Nikdy nepoužij pojistné první osoby jako totalMonthlyPremium celé smlouvy. totalMonthlyPremium = explicitní celkový součet za smlouvu, pokud existuje; jinak součet monthlyPremium všech insuredPersons. Přidej premium.calculationBreakdown.
...
- INVESTICE — INVESTOVANÁ ČÁSTKA: intendedInvestment = CELKOVÁ investovaná částka klientem za celou dobu trvání produktu.
  * JEDNORÁZOVÁ INVESTICE (např. "Pokyn k jednorázové investici", FUNDOO Jednorázová): intendedInvestment = částka uvedená u dané jednorázové investice (součet všech vybraných fondů pokud je jich více). Tuto hodnotu NESMÍŠ zaměnit s variabilním symbolem, číslem smlouvy, ISIN kódem, ani s bankovní částkou k úhradě.
  * PRAVIDELNÁ INVESTICE / PROGRAM (FUNDOO Pravidelná, RYTMUS Pravidelné investování, spořicí plán, investiční program): intendedInvestment = měsíční_investice × 12 × počet_let (pokud je doba uvedena v letech) NEBO měsíční_investice × počet_měsíců (pokud je doba v měsících). Měsíční investici dej do investmentPremium. NIKDY NEDÁVEJ MĚSÍČNÍ ČÁSTKU DO intendedInvestment u pravidelných produktů — intendedInvestment je vždy celková částka za celé období.
  * Pokud doba investování není explicitně uvedena ale je uveden investiční horizont (např. "do roku 2045" nebo "20 let"), spočítej intendedInvestment z něj.
  * Pokud nelze dobu spolehlivě určit, nech intendedInvestment prázdné a do paymentNote/evidenceSnippet napiš proč.
