...
const PRIMARY_TYPE_ALIASES: Record<string, string> = {
  ...
  dps_smlouva: "pension_contract",
  pp: "pension_contract",
  pp_smlouva: "pension_contract",
  doplnkove_penzijni_sporeni: "pension_contract",
  doplňkové_penzijní_spoření: "pension_contract",
  penzijni_pripojisteni: "pension_contract",
  penzijní_připojištění: "pension_contract",
  smlouva_dps: "pension_contract",
  smlouva_pp: "pension_contract",
  "doplňkové penzijní spoření": "pension_contract",
  "doplnkove penzijni sporeni": "pension_contract",
  "penzijní připojištění": "pension_contract",
  "penzijni pripojisteni": "pension_contract",
  // proposal
